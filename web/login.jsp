<%-- 
    Document   : login
    Created on : 9 Jul, 2019, 6:21:10 PM
    Author     : LENOVO
--%>
...
<html>
  ...
  <button type="submit" class="btn btn-outline-success"><a href="login1.jsp">Login</a></button>
        <button type="button" class="btn btn-outline-secondary"><a href="register.jsp">New</a></button>
</form>
